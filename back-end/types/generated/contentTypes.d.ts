...
export interface ApiProaccProacc extends Struct.CollectionTypeSchema {
  collectionName: 'proaccs';
  info: {
    displayName: 'proacc';
    pluralName: 'proaccs';
    singularName: 'proacc';
...
export interface ApiProshirtProshirt extends Struct.CollectionTypeSchema {
  collectionName: 'proshirts';
  info: {
    description: '';
    displayName: 'proshirt';
    pluralName: 'proshirts';
    singularName: 'proshirt';
  };
  options: {
    draftAndPublish: true;
  };
